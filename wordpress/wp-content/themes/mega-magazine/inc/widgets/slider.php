                                    ...
                                    if ( has_post_thumbnail( get_the_ID() ) ) { ?>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="post-content">
                                                ...
                                                if ( 1 === absint( $show_date ) ) { ?>

                                                    <span class="posted-date"><?php echo esc_html( get_the_date() ); ?><?php if( 1 === absint( $show_categories ) && ( 'post' === get_post_type() ) ) { echo esc_html__( ' - ', 'mega-magazine' ); } ?></span>
                                                    <?php
                                                }
